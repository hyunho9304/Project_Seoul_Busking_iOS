//
//  FollowingDetailCollectionViewCell.swift
//  Seoul_Busking_iOS
//
...
class FollowingDetailCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var followingDetailCategoryLabel: UILabel!
    @IBOutlet weak var followingDetailDateLabel: UILabel!
    @IBOutlet weak var followingDetailTimeLabel: UILabel!
    @IBOutlet weak var followingDetailZoneNameLabel: UILabel!
